    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <Card className="border-irrigation-200 dark:border-irrigation-800 shadow-sm hover:shadow-md transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium">
              {t("stats.totalModels.title")}
            </CardTitle>
            <Database className="h-4 w-4 text-irrigation-500" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-irrigation-600 dark:text-irrigation-400">
              {t("stats.totalModels.value")}
            </div>
            <p className="text-xs text-green-600">
              {t("stats.totalModels.change")}
            </p>
          </CardContent>
        </Card>
        <Card className="border-irrigation-200 dark:border-irrigation-800 shadow-sm hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-irrigation-600 dark:text-irrigation-400">
              {t("stats.activeUsers.value")}
            </div>
            <p className="text-xs text-green-600">
              {t("stats.activeUsers.change")}
            </p>
          </CardContent>
        </Card>
        <Card className="border-irrigation-200 dark:border-irrigation-800 shadow-sm hover:shadow-md transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium">
              {t("stats.waterSaved.title")}
            </CardTitle>
            <Droplets className="h-4 w-4 text-irrigation-500" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-irrigation-600 dark:text-irrigation-400">
              {t("stats.waterSaved.value")}
            </div>
            <p className="text-xs text-green-600">
              {t("stats.waterSaved.change")}
            </p>
          </CardContent>
        </Card>
      </div>
